...
class HabitHeatmapCalendarWeeklyWidget extends StatefulWidget {
  ...
  const HabitHeatmapCalendarWeeklyWidget({
    Key? key,
    required this.habitList,
  }) : super(key: key);

  @override
  State<HabitHeatmapCalendarWeeklyWidget> createState() => _HabitHeatmapCalendarWeeklyWidgetState();
}

class _HabitHeatmapCalendarWeeklyWidgetState extends State<HabitHeatmapCalendarWeeklyWidget> {
